...
public class GetterAndSetterTester {
    ...
    private String nameWithCapital(final Field field) {
        ...
        /*
           Bloco adicionado porque o Lombok remove o prefixo "is" de propriedades do
           tipo "boolean" para criar o get e o set do atributo.
           Ex.: atributo "isValido", o Lombok gera o set "setValido()" e o get "isValido()",
           e não "setIsValido()" e "isIsValido()", como esperado.
         */
        if (field.getType().equals(boolean.class) && result.length() > 2 && result.startsWith("is") && Character.isUpperCase(result.charAt(2))) {
    ...
    private void testGetterAndSetter(final Field field, final Object instance) {
        ...
        try {
            ...
            TestCase.assertEquals("Failed getter and setter test of field "
